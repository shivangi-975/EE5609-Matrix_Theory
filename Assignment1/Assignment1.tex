...
\begin{abstract}
This documnet contains the solution to a variable \emph{a,b} in a set of linear equations for infinite solution
\end{abstract}
Download all python codes from 
%
\begin{lstlisting}
https://github.com/shivangi-975/-EE5609-Matrix-Theory-/tree/master/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/shivangi-975/-EE5609-Matrix-Theory-/blob/master/Assignment1.tex
\end{lstlisting}
%
\section{Problem}
 For which value of \emph{a,b} will the following pair of linear equations have infinite solution
\begin{center}
(2   3)\textbf{x} = 7 \\
(\emph{a}-{b}  \emph{a}+{b})\textbf{x} = 3\emph{a}+{b}-2
\end{center}
%
%
\section{Solution}
...
\end{equation}
From equation \eqref{eq:kvalue},\\
For \emph{a}=5 and \emph{b}=1
\newline the given set of linear equations will have infinite solution.
\end{flushleft}
\end{document}
