...
\norm{\vec{A-B}} = \norm{\vec{B-C}} = \norm{\vec{A-C}}
\end{align}
Taking Inner Product of $\vec{BC}$ and $\vec{AC}$\\
\begin{align}\label{eq1}
\angle BCA={\vec{BC}}^T {\vec{AC}} \nonumber\\
\angle BCA =\norm{\vec{B-C}}^2\cos\theta
\end{align}
Taking Inner Product of $\vec{BC}$ and $\vec{AC}$\\
\begin{align}\label{eq2}
\angle BAC={\vec{BA}}^T {\vec{AC}} \nonumber\\
\angle BAC =\norm{\vec{B-C}}^2\cos\theta
\end{align}
Taking Inner Product of $\vec{BC}$ and $\vec{AC}$\\
\begin{align}\label{eq3}
\angle ABC ={\vec{AB}}^T{\vec{BC}} \nonumber\\
\angle ABC =\norm{\vec{B-C}}^2\cos\theta
\end{align}
From \ref{eq1},\ref{eq2} and \ref{eq3} we have
\begin{align}
\angle BCA=\angle ABC =\angle BAC
\end{align}
\end{document}
