...
\end{center}
\begin{abstract}
This document contains the concept of linear functionals.
\end{abstract}
Download all python codes from 
%
\begin{lstlisting}
https://github.com/shivangi-975/EE5609-Matrix_Theory/tree/master/Assignment15/Codes
\end{lstlisting}
%
Download latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/shivangi-975/EE5609-Matrix_Theory/blob/master/Assignment15/Assignment_15.tex
\end{lstlisting}
%
\section{Problem}
In $R^3$, let $\alpha_1 = 
...
-1\\
0}$. 
Describe a linear functional f on $R^3$ such that $f(\alpha_1)=f(\alpha_2)=0$ but $f(\alpha_3)\neq 0$.If $\alpha$=\myvec{
2\\3\\-1
}
such that $f(\alpha)\neq 0$
\section{Solution}
...
\begin{align}
\alpha_1 x_1 + \alpha_2 x_2 + \alpha_3 x_3 = \alpha\\
\alpha_1 x_1 + \alpha_2 x_2 + \alpha_3 x_3 = \myvec{a\\b\\c}
\end{align}
Hence:
\begin{align}
...
\end{align}
$ {x}=A^{-1}\alpha$ will give solution of equation.
\begin{align}
\myvec{1 & 0 & -1 & 1 & 0 & 0\\
0 & 1 & -1 & 0 & 1 & 0\\
...
\implies f(\alpha) = \myvec{\vec{u_1}^T\vec{y} & \vec{u_2}^T\vec{y} & \vec{u_3}^T\vec{y}} \myvec{f(\alpha_1)\\f(\alpha_2)\\f(\alpha_3)}\\
\implies f(\alpha) = \vec{x}^T \myvec{f(\alpha_1)\\f(\alpha_2)\\f(\alpha_3)}
\end{align}
Given, $f(\alpha_1)=f(\alpha_2)=0$ and $f(\alpha_3)\neq 0$.
\begin{align}
 f(\alpha) = \vec{x}^T \myvec{0\\0\\f(\alpha_3)}\\
\implies f(\alpha) = \myvec{
\vec{u_3}^T\vec{y}
} f(\alpha_3)
\end{align}
Now for $\alpha$=\myvec{2,3,-1}
 to prove $f(\alpha)\neq 0$ ,
\begin{align}
    \implies f(\alpha)=\myvec{ \vec{u_3}^T\vec{y}
}f(\alpha_3)\\
\implies -3f(\alpha_3)\neq 0
\end{align}
