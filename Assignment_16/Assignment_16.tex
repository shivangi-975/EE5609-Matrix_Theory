...
%
\begin{lstlisting}
https://github.com/shivangi-975/EE5609-Matrix_Theory/tree/master/Assignment16/Codes
\end{lstlisting}
%
Download latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/shivangi-975/EE5609-Matrix_Theory/blob/master/Assignment16/Assignment_16.tex
\end{lstlisting}
%
\section{Problem}
If f  and g are independent polynomials over a field $\vec{F}$and h is a non-zero
...
Substituting in equation \eqref{eqs} we have,
\begin{align}
a(fh)+b(gh)=0\\
(af)h+(bg)h=0\\
(af+bg)h=0\\
af+bg=0
\end{align}
f  and g are independent polynomial.Also from equation \eqref{eq1} a=0 and b=0.\\
