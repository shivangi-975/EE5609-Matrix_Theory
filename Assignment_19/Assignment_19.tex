...
$\myvec{1\\3\\9}$\\
 & We have found only two linearly independent eigenvectors for A,Hence not diagonalisable
\\
\hline
& \\
...
\hline
&\\
True statement& A has n linearly independent eigenvectors which implies it is diagonalizable.\\
Proof & \textbf{Suppose A is Diagonalizable}.Than,$P^{-1}AP=D$ and hence,AP=PD\\
& where P is invertible matrix and D is a diagonal matrix.\\
& D=\myvec{\lambda_1&0&\cdots&0\\
0&\lambda_2&\cdots&0\\
...
\\
& So,$AP_i$=$\lambda_iP_i$ where $i=1,\cdots,n$\\
& Now,P is invertible .Hence,$P_i$ is eigen vector of A for $\lambda$\\
& Also rank(P)=n.So it's columns $\myvec{
P_1&P_2&\cdots&P_n
}$
...
p_1 &p_2&\cdots&p_n 
 ...
 $AP_1=\lambda P_1,\cdots ,AP_n=\lambda P_n$\\
& D=\myvec{\lambda_1&0&\cdots&0\\
0&\lambda_2&\cdots&0\\
\vdots&\vdots&\vdots&\vdots\\
0&0&\cdots&\lambda_n}
...
& Now, $AP_i=\lambda_iP_i$ $\implies$ $AP=PD$ so,$P^{-1}AP=D$ is a diagonal matrix.\\
\hline
& \\
...
2& 5 &4\\
0& 0 &5
}$\implies \lambda_1=2,\lambda_2=3 , \lambda_3=6$\\
& Eigen vectors are:$x_1=\myvec{
-1\\1\\0
},
x_ 2=\myvec{
1\\1\\1
...
\hline
& \\
False statement & counter example same as statement 1 ex. eigen values are non zero but not diagonalizable. \\
\hline
\end{tabular}
\end{center}
\end{table*}
